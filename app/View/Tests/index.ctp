<div class="tests index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('take_test_url'); ?></th>
			<th><?php echo $this->Paginator->sort('url_slug'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($test['Test']['icon']); ?>&nbsp;</td>
		<td><?php echo h($test['Test']['take_test_url']); ?>&nbsp;</td>
		<td><?php echo h($test['Test']['url_slug']); ?>&nbsp;</td>
		<td><?php echo h($test['Test']['is_active']); ?>&nbsp;</td>
